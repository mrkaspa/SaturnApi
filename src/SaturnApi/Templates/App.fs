    ...
    html [ _class "has-navbar-fixed-top" ] 
        [ head [] [ meta [ _charset "utf-8" ]
                    ...
                    link [ _rel "stylesheet"
                           _href "/app.css" ] ]
          body [] [ yield nav [ _class "navbar is-fixed-top has-shadow" ] 
                              [ div [ _class "navbar-brand" ] 
                                    [ a [ _class "navbar-item"
                                          _href "/" ] [ img [ _src 
                                                                  "https://avatars0.githubusercontent.com/u/35305523?s=200"
                                                              _width "28"
                                                              _height "28" ] ]
                                    ...
                                    [ div [ _class "navbar-start" ] 
                                          [ a 
                                                [ _class "navbar-item"
                                                  ...
                                                  _href 
                                                      "https://github.com/SaturnFramework/Saturn/blob/master/README.md" ] 
